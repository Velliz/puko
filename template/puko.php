            ...
            case "add":
                ...
                if (sizeof($controllerExplode) == 1) {
                    ...
                    if (!file_exists(__DIR__ . "\\" . $namespaces . "\\" . $className . ".php")) {
                        ...
                        $existingController = file_get_contents(__DIR__ . "\\" . $namespaces . "\\" . $className . '.php');
                        $pos = strrpos($existingController, "}");
                        $existingController = substr_replace($existingController, "    public function $function(){}\n\n}", $pos);
                        file_put_contents(__DIR__ . "\\" . $namespaces . "\\" . $className . '.php', $existingController);
                    }
                } else {
                    ...
                    if (!file_exists(__DIR__ . "\\" . $namespaces . str_replace('\\', '/', $controller . '.php'))) {
                        file_put_contents(__DIR__ . "\\" . $namespaces . str_replace('\\', '/', $controller . '.php'), $varNewFile);
                    } else {
                        $existingController = file_get_contents(__DIR__ . "\\" . $namespaces . str_replace('\\', '/', $controller . '.php'));
                        $pos = strrpos($existingController, "}");
                        $existingController = substr_replace($existingController, "    public function $function(){}\n\n}", $pos);
                        file_put_contents(__DIR__ . "\\" . $namespaces . str_replace('\\', '/', $controller . '.php'), $existingController);
                    }
